...
Our study, an ex-post policy analysis reflecting the ongoing relevance of the topic, investigates Progresa's impact on children's school enrollment via regression analysis. By using methods such as simple differences, linear, multiple and logistic regressions, as well as IV and DiD our results consistently show a positive impact on enrollment rates.\
...
Here, in addition, is a brief list of our regression formulas (respectively those are the linear, multivariate, logistic and DiD):
